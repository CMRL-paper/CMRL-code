...
class UniXcoder(nn.Module):
    def __init__(self, model_name):
        ...
        self.tokenizer = RobertaTokenizer.from_pretrained(model_name, proxies=proxies)
        self.config = RobertaConfig.from_pretrained(model_name, proxies=proxies)
        self.config.is_decoder = True
        self.model = RobertaModel.from_pretrained(model_name, config=self.config, proxies=proxies)
